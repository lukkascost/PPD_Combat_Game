...
public interface IGame  extends Remote {
     ...
     String movementPieceSecondClick(int line, int col, int vertical,int horizontal, boolean j1) throws RemoteException;
     void cleanGame()throws RemoteException;
     String swap(int position1, int position2) throws RemoteException;
