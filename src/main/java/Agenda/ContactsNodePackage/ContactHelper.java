...
/**
* Agenda/ContactsNodePackage/ContactHelper.java .
...
{
  private static String  _id = "IDL:Agenda/ContactsNode/Contact:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (Agenda.ContactsNodePackage.ContactHelper.id (), "Contact", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    Agenda.ContactsNodePackage.Contact value = new Agenda.ContactsNodePackage.Contact ();
